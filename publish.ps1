#!/usr/bin/env pwsh
# publish.ps1 — sync wiki changes to Quartz and push to GitHub Pages
...
# 1. Sync wiki pages (entities, concepts, topics, summaries, index, log)
...
Write-Host "  https://yy1781051483.github.io/duan-wiki/" -ForegroundColor Blue
